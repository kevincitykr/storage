...
# Remove d-drive-full if it exists (cleaning up previous attempt)
config['folders'] = [f for f in config['folders'] if f['id'] != 'd-drive-full']
...
if not exists:
    ...
    print("Folder '운영체제' added to config.")
else:
    print("Folder '운영체제' already exists in config.")
