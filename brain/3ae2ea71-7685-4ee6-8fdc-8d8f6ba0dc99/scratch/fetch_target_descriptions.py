...
def fetch_descriptions():
    ...
    video_ids = ["cakzqLs1Q-4", "0HQMQXyEwfo"]
    results = {}
    ...
    output_path = r"C:\Users\ksohw\.gemini\antigravity\brain\3ae2ea71-7685-4ee6-8fdc-8d8f6ba0dc99\scratch\target_video_descriptions.json"
    with open(output_path, 'w', encoding='utf-8') as f:
        json.dump(results, f, ensure_ascii=False, indent=4)
    print(f"Saved target descriptions to {output_path}")
